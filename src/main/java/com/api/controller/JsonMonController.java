...
@Controller
public class JsonMonController {
	public MonParameter mpara ;
	Configuration conf = null;
	@Authentication(validate=false)
	@RequestMapping(value="/api/mon",method=RequestMethod.POST,produces="text/html;charset=UTF-8")
	@ResponseBody
	public String monJSON(@RequestBody String jsonData,HttpServletRequest req, HttpServletResponse resp) {
